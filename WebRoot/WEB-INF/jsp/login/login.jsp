...
#login .logo {
 ...
 <body>
  ...
  <div id="login">
   <div class="inner">
    <div class="logo">
     <img src="plug-in/login/images/toplogo-jeecg-mra.png"/>
    </div>
    <div class="formLogin">
     <form name="formLogin" id="formLogin" action="loginController/login.do" check="loginController.do?checkuser" method="post">
  ...
  <div id="versionBar">
   <div class="copyright">
    &copy; 版权所有
    <span class="tip"><a href="#" title="${title }">chuzj</a> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="#" title="${title }">chuzj</a></span>
   </div>
  </div>
    <!-- Link JScript-->
